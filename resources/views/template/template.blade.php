      ...
      <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
          ...
          <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
            ...
            <div class="sidebar-brand-text mx-3">Teste Uplexis</div>
          </a>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('requisicao')}}">
              <i class="fas fa-fw fa-arrow-circle-right"></i>
              <span>Requisição</span></a>
          </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
              ...
              <!-- Topbar Search -->
              {!! Form::open(['route' => 'requisicao', 'class' => 'd-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search']) !!}
                @csrf
              <!-- <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search"> -->
                <div class="input-group">
                  <!-- <input type="text" class="form-control bg-light border-0 small" placeholder="Pesquisa no Blog" aria-label="Search" aria-describedby="basic-addon2"> -->
                  {!! Form::text('texto', null, ['placeholder' => 'Pesquisa no blog', 'class' => 'form-control bg-light border-0 small', "required" ]) !!}
                  <div class="input-group-append">
                      <!-- {!! Form::submit('Enviar Agora', ['class' => 'btn btn-primary']) !!} -->
              ...
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow d-sm-none">
                  ...
                  <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in" aria-labelledby="searchDropdown">
                    {!! Form::open(['route' => 'requisicao', 'class' => 'form-inline mr-auto w-100 navbar-search']) !!}
                      @csrf
                ...
                <li class="nav-item dropdown no-arrow">
                  <a class="nav-link dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false">
                    ...
                    <img class="img-profile rounded-circle" src="http://stie-yadika.ac.id/assets/web/images/pegawai.png">
                  </a>
                </li>
